...
const data = [
  {
    ...
    aboutMe:
      "I am the type of person who enjoys trying new things and taking on new challenges.",
    age: 21,
    city: "Chabua, Assam",
    programmingLanguages: "C++, Javascript",
    interests:
      "Web Development, Content Creation, Reading Self Growth Books & listening to the Stories of Indian Armed Forces are my interests",
...

  {
    ...
    aboutMe:
      "I am a web developer who has a keen interest in AI/ML and data science.",
    age: 20,
    city: "Indore, Madhya Pradesh",
    programmingLanguages: "C++, C, Python",
    interests:
      " Community management is one of my hobbies these days. I do love to create Spotify playlists too.",
...

  {
    name: "Dev Raj Bharti",
    aboutMe:
      "I am Dev Raj Bharti, a passionate 2nd year Student at SMIT. I like to do coding and be around what makes me better.",
    age: 20,
...

  {
    ...
    age: 21,
    aboutMe:
      "I am Diwas Mundra a Student of CSE at Sikkim Manipal Institute of Technology",
    city: "Gangtok, Sikkim",
...

  {
    ...
    age: 20,
    aboutMe:
      "I am Adarsh Sharma I am basically a learner. Generally prefer learning new things.",
    city: "Gangtok, Sikkim",
...
function nextCV() {
  ...
  if (CurrentCandidate != undefined) {
    image.innerHTML = `<img alt='${CurrentCandidate.name}' src='${CurrentCandidate.image}' height='90' width='90'>`;
